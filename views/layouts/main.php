...
<body>
    ...
    <header>
        <div class="header-holder mobile-only">
          <a href="#bag-items" class="bag-icon js-slide"><img src="images/icon-bag.svg" alt="Open bag" /><span class="bag_number_of_items">0</span></a>
          <a href="#menu-categories" id="open-menu" class="menu-icon js-slide"><img src="images/icon-menu.svg" alt="Open menu" /></a>
          <a href="#search, #search-field" class="search-icon js-open"><img src="images/icon-magnifier.svg" alt="Search" /></a>
          <div class="header-logo"><a href="/"><img src="images/logo.png" alt="Jolilook" /></a></div>
      </div>
      <div class="header-content">
        <div class="holder">
            <div class="content-holder">
                <div class="header-logo desktop-only"><a href="/"><img src="images/logo.png" alt="Jolilook" /></a>
                </div>
                <nav id="main-nav" class="menu-holder">
                    <div id="slideout-header" class="nav-header mobile-only">
                      <a href="#" class="back-icon js-slide"><img src="images/icon-back.svg" alt="Back" /></a>
                      <h2 class="menu-title"></h2>
                      <a href="#" class="js-close close-icon right"><img src="images/icon-menu.svg" alt="Close menu" /></a>
                  </div>
                  <ul id="menu-categories" class="menu-list slideout" data-menutitle="">
                    ...
                    <li data-menutitle="Login" class="mobile-only noborder">
                        <a href="user" class="boxed">Login</a>
                    </li>
                    <li id="women-li" class="hspace">
                        <a href="index.php?r=site%2Fwomen" class="desktop-only selected">Women</a>
                        ...
                        <div id="women" class="slideout" data-menutitle="Women">
                            <ul id="women_sub_nav">
                                <li data-menutitle="Women - Eyeglasses" >
                                    ...
                                    <img src="images/collections/women/emily-luciano/menu_eyeglasses.jpg" class="desktop-only" alt="" />
                      ...
                      <li data-menutitle="Women - Sunglasses" >
                          <a href="/sunglasses/women">
                            <img src="images/menu_sunglasses.jpg" class="desktop-only" alt="" />
                  ...
                  <li data-menutitle="Women - Accessories"  class="desktop-only">
                      <a href="/accessories/women">
                        <img src="images/menu/women/menu_accessories.jpg" class="desktop-only" alt="" />
                ...
                <li data-menutitle="Women - our bestsellers"  class="desktop-only">
                  <a href="/women/bestsellers">
                    <img src="images/women/menu_bestsellers_women.jpg" class="desktop-only" alt="" />
...
<li id="men-li">
    <a href="index.php?r=site%2Fmen" class="desktop-only ">Men</a>
      ...
      <ul id="men_sub_nav">
       <li data-menutitle="Men - Eyeglasses">
        <a href="/eyeglasses/men">
          <img src="images/collections/men/studio/homepage/genderless/menu_studio_eyeglasses.jpg" class="desktop-only" alt="" />
          <em class="desktop-only">see</em>eyeglasses
      </a>
...
<li data-menutitle="Men - Sunglasses">
    <a href="/sunglasses/men">
      <img src="images/collections/men/studio/homepage/genderless/menu_studio_sunglasses.jpg" class="desktop-only" alt="" />
      <em class="desktop-only">see</em>sunglasses
  </a>
...
<li data-menutitle="Men - Accessories" class="desktop-only">
    <a href="/accessories/men">
      <img src="images/menu/men/menu_accessories.jpg" class="desktop-only" alt="" />
      <em class="desktop-only">see</em>Accessories
  </a>
  <div id="" class="slideout mobile-only" data-menutitle="">
      <ul>
...
<li data-menutitle="Men - our bestsellers" class="desktop-only">
    <a href="/men/bestsellers">
      <img src="images/men/menu_bestsellers_men2.jpg" class="desktop-only" alt="" />
      <em class="desktop-only">shop</em>our bestsellers
  </a>
  <div id="" class="slideout mobile-only" data-menutitle="">
      <ul>
...
<li id="collab-li"><a href="#collab" class="js-slide ">Collections</a>
    ...
    <ul id="collab_sub_nav">
      <li data-menutitle="Collections - Emily Luciano">
        <a href="/women/collection/emily-luciano">
          <img src="images/collections/women/emily-luciano/menu_collection.jpg" class="desktop-only" alt="" />
  ...
  <li data-menutitle="Collections - Luxe Essential">
    <a href="/women/collection/luxe-essential">
      <img src="images/collections/luxe-essential/menu_collection.jpg" class="desktop-only" alt="" />
...
<li data-menutitle="Collections - Mariper Morin">
    <a href="/women/collection/maripier-morin">
      <img src="images/menu/collaborations/mpmorin_menu.jpg" class="desktop-only" alt="" />
      <em class="desktop-only">view</em>Mariper Morin
  </a>
</li>
<li data-menutitle="Collections - All collections">
    <a href="/women/collection/all">
      <img src="images/collections/quartz/quartz_menu.jpg" class="desktop-only" alt="" />
    ...
    <ul>
      <li data-menutitle="Help - Contact us">
        <a href="/contact#main" class="faq">
          <img class="desktop-only" src="images/menu/menuhelp_prescription.jpg" alt="" />
          <span>Contact us</span>
      </a>
  </li>
  <li data-menutitle="Help - Faqs">
    <a href="/contact#main" class="faq">
      <img class="desktop-only" src="images/menu/menuhelp_faq.jpg" alt="" />
...
<ul id="menu-account" class="desktop-only">
    ...
    <li data-menutitle="Login">
      <a href="index.php?r=site%2Fuser">Login</a>
  </li>
  <li data-menutitle="My bag" class="bag">
      <a id="cart-desktop_link" href="#bag-items" class="js-slide">
        <span class="invisible">My bag</span>
        <div class="bag-icon">
          <img src="images/icon-bag.svg" class="mobile-only" alt="Open bag" />
          <img src="images/icon-bag.png" class="mobile-hide" alt="Open bag" />
...
<div id="sub-nav">
    <div id="shopping-cart" class="menu-holder cart">
        <div id="tablet-nav-header" class="nav-header">
            <a href="#" class="js-close close-icon x"><img src="images/icon-close.svg" alt="Close menu" /></a>
        </div>
            ...
            <div class="totals">
                ...
                <div class="remove-new-coupon-section" >
                    <p class="coupon">
                        ...
                        Applied<img src="images/icon-close.svg" alt="remove coupon"/>
                        </a>
                    </p>
                </div>
    ...
    <div id="search">
        <div id="search-field" class="content">
            <form id="search-form" action="/search" method="post">
                ...
                <a href="#" class="js-close close-icon"><img src="images/icon-close.svg" alt="Close menu" /></a>
            </form>
        </div>
    </div>
</div>
...
<div class="wrapper">
        <div id="footer_container">
          <div class="row">
            <div class="footer-infos col-xs-12 col-sm-4 col-lg-2">
              <div class="footer-logo"><a href="/"><img src="images/jolilook.png" alt="Jolilook" /></a>
              </div>
            ...
            <div class="col-xs-12 col-sm-4 col-lg-4 col-lg-push-2">
              <div class="social-icons">
                <a href="//www.facebook.com/Jolilook.eyewear" target="_blank"><img src="images/icon_fb.png" alt="Facebook JoliLook" /></a>
                <a href="//twitter.com/JoliLook" target="_blank"><img src="images/icon_tw.png" alt="Twitter JoliLook" /></a>
                <a href="//instagram.com/Jolilook" target="_blank"><img src="images/icon_insta.png" alt="Instagram JoliLook" /></a>
                <a href="//pinterest.com/Jolilook/" target="_blank"><img src="images/icon_pin.png" alt="Pinterest JoliLook" /></a>
                <a href="images/snap_chat_pop_up.jpg" target="_blank" class="popup"><img src="images/snapchat_icon.png" alt="Snapchat JoliLook" /></a>
              </div>
        ...
        <div id="subscribeForm_container">
          ...
          <div class="subscribe-form-content">
            ...
            <img src="images/icon-close.svg" alt="Close menu" /></a>
        ...
        <img src="images/newsletter_arrow.jpg" alt="Arrow right"></p>
