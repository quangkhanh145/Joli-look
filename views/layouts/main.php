...
<body>
    ...
    <header>
        <div class="header-holder mobile-only">
          ...
          <div class="header-logo"><a href="/"><img src="<?=Yii::$app->homeUrl?>images/logo.png" alt="Jolilook" /></a></div>
      </div>
      <div class="header-content">
        <div class="holder">
            <div class="content-holder">
                <div class="header-logo desktop-only"><a href="/"><img src="<?=Yii::$app->homeUrl?>images/logo.png" alt="Jolilook" /></a>
                </div>
